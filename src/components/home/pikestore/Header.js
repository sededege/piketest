...
import { AiOutlineShoppingCart, AiOutlineSearch,AiOutlineClose,AiOutlineMenu } from "react-icons/ai";
    ...
    >
      ...
      </p>
     {
      ...
      <div className="flex gap-2">
        ...
        >
          {
            cartItems.length > 0 && <p className="absolute  bottom-4 left-3 bg-red-500 w-5 h-5 text-[12px] items-center flex justify-center text-white rounded-full ">
            {cartItems.length}
          </p>
          }
